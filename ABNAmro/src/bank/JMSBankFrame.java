...
import message.BrokerToBankReceiver;
import message.BankToBrokerSender;
...
public class JMSBankFrame extends JFrame {
    ...
    private final Map<BankInterestRequest, String> correlation = new HashMap<>();
    private static BrokerToBankReceiver receiver;
    private BankToBrokerSender sender;
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    receiver = new BrokerToBankReceiver(frame);
        ...
        btnSendReply.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (rr != null && reply != null) {
                    rr.setReply(reply);
                    list.repaint();
                    sender = new BankToBrokerSender(rr.getReply().toString(), correlation.get(rr.getRequest()));
                }
            }
        });
    ...
    public void add(BankInterestRequest request, String messageId) {
        correlation.put(request, messageId);
