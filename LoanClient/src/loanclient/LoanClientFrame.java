...
public class LoanClientFrame extends JFrame {
    ...
    public void addCorrelation(String messageId, LoanRequest request) {
        correlation.put(messageId, request);
    }

    public void addRequestReply(String messageId, LoanReply reply) {
        RequestReply rr = getRequestReply(correlation.get(messageId));
        if (rr != null) {
            rr.setReply(reply);
        }
