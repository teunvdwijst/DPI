 ...
 * @author Teun
 */
public class BrokerToClientSender {
    ...
    public BrokerToClientSender(String message, String messageId) {
        try {
            ...
            sendDestination = (Destination) jndiContext.lookup("BrokerToClient");
